...
print(f"PlayerOne: {lottery_numbers.intersection(playerOne['numbers'])} are matching numbers!")
print(f"PlayerTwo: {lottery_numbers.intersection(playerTwo['numbers'])} are matching numbers!")